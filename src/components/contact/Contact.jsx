...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_nzsrp6n','template_cw1qqq9',formRef.current,'NrIgVtu9UzV6uQ6m5')
          .then((result) => {
            setSuccess(true);
          }, (error) => {
            setError(true)
        ...
        <motion.div  className="contact"  variants={variants} initial="initial" whileInView="animate" ref={ref}>
         <motion.div className="textContainer" variants={variants}>
            ...
            <motion.div className="item" variants={variants}>
                <h2>Mail</h2>
                <span>kamaliravi5722@gmail.com</span>
            </motion.div>
            <motion.div className="item" variants={variants}>
                <h2>Address</h2>
                <span>535/2 Main Road , Kumaratchi , kattumarkovil TK - 608302</span>
            </motion.div>
            <motion.div className="item" variants={variants}>
                <h2>Phone</h2>
                <span>7904211379,8098924562</span>
            </motion.div>
